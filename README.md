...
* Отредактируйте config.json в зависимости от задач поиска.
* Укажите необходимые запросы в файле requests.json.
* Запустите исполняемый файл.
* в папке resources появится answers.json с ответами на ваши запросы.
